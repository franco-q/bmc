...
<script>
import LineChart from '@/vue/components/Charts/LineChart';
import BarChart from '@/vue/components/Charts/BarChart';
import PieChart from '@/vue/components/Charts/PieChart';
